...
let PlansController = class PlansController {
    plansService;
    logger;
    constructor(plansService, logger) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Plans fetched successfully' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Plan fetched successfully' }),
